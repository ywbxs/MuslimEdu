...
export async function submitReport(
  ...
  // Omit report_month to submit for the current month (backend default).
  // Passing it lets a child catch up on a missed past month, the same way
  // an admin can back-date a report via admin_orphan_report_create.
