...
// regardless of what's behind it - on the SAME single path as the fill so
// it can't develop the fill/border silhouette mismatch that caused the
// earlier "nested pill" bug.
