...
function AddCashierSheet({
  ...
  const handleCreate = async () => {
    ...
    if (!name.trim() || !email.trim() || !password.trim()) {
      Alert.alert(t('cashier_accounts.almost_done', 'Almost done'), t('cashier_accounts.error_required_fields', 'Name, email, and password are required.'));
      return;
    }
    if (password.trim().length < 6) {
      Alert.alert(t('cashier_accounts.almost_done', 'Almost done'), t('cashier_accounts.error_password_length', 'Password must be at least 6 characters.'));
      return;
    }
      ...
      <View style={styles.sheetBackdrop}>
        ...
        <View style={styles.formSheet}>
          ...
          <View style={styles.sheetHeaderRow}>
            <Text style={styles.sheetTitle}>{t('cashier_accounts.add_cashier_title', 'Add Cashier')}</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            <Text style={styles.fieldLabel}>{t('cashier_accounts.full_name_label', 'Full Name')}</Text>
            <TextInput
            ...
            <Text style={styles.fieldLabel}>{t('cashier_accounts.password_label', 'Password')}</Text>
            <TextInput
              style={styles.fieldInput}
            ...
            <Text style={styles.fieldLabel}>{t('cashier_accounts.phone_label', 'Phone (optional)')}</Text>
            <TextInput
              style={styles.fieldInput}
            ...
            >
              {isSubmitting ? (
                ...
                <Text style={styles.submitButtonText}>{t('cashier_accounts.add_cashier_title', 'Add Cashier')}</Text>
              )}
            </TouchableOpacity>
          </ScrollView>
        </View>
