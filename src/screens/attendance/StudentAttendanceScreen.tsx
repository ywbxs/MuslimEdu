              ...
              return (
                <View key={`${point.year}-${point.month}`} style={styles.trendCol}>
                  ...
                  <View
                    style={[
                      styles.trendBar,
                      { height, backgroundColor: isCurrent ? '#1F9254' : '#CBD5D1' },
                    ]}
                  />
...
const styles = StyleSheet.create({
  ...
  retry: { marginTop: 20, backgroundColor: '#1F9254', paddingHorizontal: 24, paddingVertical: 11, borderRadius: 8 },
  ...
  rateValue: { fontSize: 40, fontWeight: '800', color: '#1F9254' },
